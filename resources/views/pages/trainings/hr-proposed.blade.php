	...
	<div class="row">
        ...
        <div class="col-3 mt-2">
            <div class="form-group">
                ...
                <input class="fandate form-control form-control-sm{{ $errors->has('end_date') ? ' is-invalid' : '' }}" type="text" name="end_date" placeholder="When would it end?" value="{{ old('end_date') }}">
